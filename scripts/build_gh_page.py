...
.yesrec+.sect{{margin-top:10px}}.sect+.lghead{{margin-top:6px}}.sect{{margin:16px 0 4px;font-size:13px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#6b6b72}}
